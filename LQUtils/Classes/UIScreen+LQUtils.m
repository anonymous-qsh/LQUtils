...
#import "UIScreen+LQUtils.h"

@implementation UIScreen (LQUtils)

+(float) statusHeight{
  CGRect rectStatus = [[UIApplication sharedApplication] statusBarFrame];
  NSLog(@"status width - %f", rectStatus.size.width); // width
  NSLog(@"status height - %f", rectStatus.size.height);   // height
